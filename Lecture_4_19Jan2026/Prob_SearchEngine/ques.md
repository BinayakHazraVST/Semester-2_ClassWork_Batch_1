...
Rules
1 Use only JavaScript string methods covered in class
2 Arrays, loops, and regular expressions are NOT allowed
3 Write clean, readable code with meaningful comments
Challenges
